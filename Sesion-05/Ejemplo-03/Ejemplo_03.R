...
# Nota: se recomienda mucho correr el código que combina la función `tune` y la función `svm` antes de la sesión del work, esto porque se requiere mucho tiempo para que se obtengan los resultados.
